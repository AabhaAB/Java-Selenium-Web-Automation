...
public class MyAccountViewOrders {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.partialLinkText("Orders")).click();   //Click on Orders link
		
		driver.findElement(By.xpath("//*[@id=\"page-36\"]/div/div[1]/div/table/tbody/tr/td[5]/a")).click();  //Click on View Orders
